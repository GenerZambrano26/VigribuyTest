<%-- 
    Document   : Default
    Created on : 07-dic-2022, 8:53:54
    Author     : GENER
--%>
                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse sub-menu-bar" id="navbarTwo">
                            <ul class="navbar-nav m-auto">
                                ...
                                <li class="nav-item"><a class="page-scroll" href="View/Department.jsp">Servicios</a></li>
                            ...
                            <div class="col-lg-6">
                                <div class="slider-content">
                                    ...
                                    <ul class="slider-btn rounded-buttons">
                                        <li><a class="main-btn rounded-one" href="#">COMENZAR</a></li>
                                        <li><a class="main-btn rounded-two" href="#">REGISTRAR</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div> <!-- row -->
